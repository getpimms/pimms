    ...
    <Section className="py-12 sm:py-16 md:py-20" id="lifetime">
      <div className="space-y-10 md:space-y-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto">
          ...
          {/* Pro Plan */}
          <div className="bg-white rounded-2xl border-2 border-[#3970ff] p-6 md:p-8 relative">
        ...
        {/* Business Plan */}
        {showBusinessPlan && (
          <div className="max-w-5xl mx-auto bg-white rounded-2xl border border-gray-200 p-6 md:p-10">
